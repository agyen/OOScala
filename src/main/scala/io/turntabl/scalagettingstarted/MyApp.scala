...
import io.turntabl.functions._
import io.turntabl.students.TLCStudent
import io.turntabl.students.TurntablEmployee
...
//  def employee(emp: TurntablEmployee) = emp.Workload()
//  println(employee(stu2))


//  println(func.ApplyToString("hello", func.numberOfSpaces))
